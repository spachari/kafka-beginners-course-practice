...
public class ElasticSearchConsumerImprovedPerformance3 {
    ...
    public static KafkaConsumer<String, String> createConsumer(String topic) {
        ...
        properties.setProperty(ConsumerConfig.MAX_POLL_RECORDS_CONFIG, "10"); //This will enable only 10 records to be polled max
    ...
    public static void main(String[] args) throws IOException {
        ...
        Logger logger = LoggerFactory.getLogger(ElasticSearchConsumerImprovedPerformance3.class);
